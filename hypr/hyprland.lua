...
hl.bind(
  mainMod .. " + bracketleft",
  hl.dsp.exec_cmd("brightnessctl -d kbd_backlight set 5%-"),
  { locked = true, repeating = true }
)
...
hl.window_rule({
  name = "inkscape-nvim-popup",
  match = {
    initial_class = "^popup-bottom-center$",
  },
  float = true,
  size = { 800, 200 },
  center = true,
...
hl.window_rule({
  name = "inkscape-wayland-workspace",
  match = {
